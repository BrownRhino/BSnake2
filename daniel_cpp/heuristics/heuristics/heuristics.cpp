...
//int* abNegamax(const GameState& G, int max_depth, int current_depth, int alpha, int beta, bool us)
//{
//	int* scoreandmove = new int[2];
//
//	if ((gameWin(G) || gameLoss(G)) || current_depth == max_depth)
//	{
...
int main()
{
	GameState *gs;
	gs = GameState::buildFromCin();
	//abNegamax(*gs, 100, 0, MIN_VAL, MAX_VAL, false);
